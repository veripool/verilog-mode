...
(defun verilog-in-deferred-immediate-final-p ()
  "Return true if inside an =E2=80=98assert/assume/cover final=E2=80=99 statement."
  (interactive)
...
TYPE is =E2=80=98module=E2=80=99, =E2=80=98tf=E2=80=99 for task or function, or t if unknown."
...
If VERILOG-FLAG is =E2=80=98lambda=E2=80=99, the function returns t if VERILOG-STR is an
...
an exact match.  If VERILOG-FLAG is =E2=80=98lambda=E2=80=99, the function returns t if
...
(defun verilog-read-sub-decls-expr (submoddecls comment port expr)
  ...
  ;;(message "vrsde: =E2=80=98%s=E2=80=99" expr)
  ...
  (cond
   ...
   (t
    (let (sig vec multidim)
      ...
      (setq expr (verilog-string-replace-matches "^\\s-*[---+~!|&]+\\s-*" "" nil nil expr))
      ;;(message "vrsde-ptop: =E2=80=98%s=E2=80=99" expr)
      (cond  ; Find \signal. Final space is part of escaped signal name
       ((string-match "^\\s-*\\(\\\\[^ \t\n\f]+\\s-\\)" expr)
	;;(message "vrsde-s: =E2=80=98%s=E2=80=99" (match-string 1 expr))
	...
	;;(message "vrsde-v: =E2=80=98%s=E2=80=99" (match-string 1 expr))
	...
	(setq vec (match-string 1 expr)
      ...
      ;;(message "vrsde-rem: =E2=80=98%s=E2=80=99" expr)
...
(defun verilog-decls-get-signals (decls)
  "Return all declared signals in DECLS, excluding =E2=80=98assign=E2=80=99 statements."
  (append
...
Lisp Templates:
  ...
  Lisp functions:
	...
	vl-bits        Bus bits portion of the input/output port (=E2=80=98[2:0]=E2=80=99).
	vl-mbits       Multidimensional array bits for port (=E2=80=98[2:0][3:0]=E2=80=99).
	vl-width       Width of the input/output port (=E2=80=983=E2=80=99 for [2:0]).
                       May be a (...) expression if bits isn't a constant.
	vl-dir         Direction of the pin input/output/inout/interface.
	vl-modport     The modport, if an interface with a modport.
	vl-cell-type   Module name/type of the cell (=E2=80=98InstModule=E2=80=99).
	vl-cell-name   Instance name of the cell (=E2=80=98instName=E2=80=99).
...
Files are checked based on `verilog-library-flags'."
  ...
  (save-excursion  ; implement a Verilog specific ffap
	...
	(if (and (car (verilog-library-filenames
	  ...
	  (when warn
	    (message
	     "File =E2=80=98%s=E2=80=99 isn't readable, use shift-mouse2 to paste in this field"
	     (match-string 1))))))))
